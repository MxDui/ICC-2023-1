...
public class TestEstudiante {
     ...
     */
    @Test
    public void testCuentaProperty() {
        String nombre = nombreAleatorio();
        int cuenta = cuentaAleatoria();
        double promedio = promedioAleatorio();
        int edad = edadAleatoria();
     ...
     */
    @Test
    public void testPromedioProperty() {
        String nombre = nombreAleatorio();
        int cuenta = cuentaAleatoria();
        double promedio = promedioAleatorio();
        int edad = edadAleatoria();
    ...
    public void testEquals() {
        ...
        int otraEdad = edad + 1;
        Estudiante distinto = new Estudiante(otroNombre, cuenta, promedio, edad);
    ...
    public void testActualiza() {
        ...
        Assert.assertFalse(estudiante.nombreProperty() == e.nombreProperty());
        Assert.assertFalse(estudiante.cuentaProperty() == e.cuentaProperty());
        Assert.assertFalse(estudiante.promedioProperty() == e.promedioProperty());
        Assert.assertFalse(estudiante.edadProperty() == e.edadProperty());
        try {
